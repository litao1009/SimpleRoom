...
#ifndef __InterpolationCameraNode__
#define __InterpolationCameraNode__
...
namespace scene
{
	...
	class InterpolationCameraNode : public ICameraSceneNode
	{
	public:

		//! constructor
		InterpolationCameraNode(ISceneNode* parent, ISceneManager* mgr, s32 id,
		...
		irr::scene::ISceneNodeAnimatorFinishing*	GetAnimator() const { return static_cast<irr::scene::ISceneNodeAnimatorFinishing*>(Animator_); }
	...
	protected:
		...
		irr::scene::ISceneNodeAnimator*	Animator_;
	};
