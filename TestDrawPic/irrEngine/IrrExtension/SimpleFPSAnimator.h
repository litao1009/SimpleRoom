#ifndef SimpleFPSAnimator_h__
#define SimpleFPSAnimator_h__
...
class CSimpleFPSAnimator : public irr::scene::ISceneNodeAnimatorCameraFPS
{
public:

	//! Constructor
	CSimpleFPSAnimator(irr::gui::ICursorControl* cursorControl,
		irr::f32 rotateSpeed = 100.0f, irr::f32 moveSpeed = 2.f);

	//! Destructor
	virtual ~CSimpleFPSAnimator();
