#ifndef OrthoCameraRH_h__
#define OrthoCameraRH_h__

#include "ICameraSceneNode.h"
#include "SViewFrustum.h"

class COrthoCameraRH : public irr::scene::ICameraSceneNode
{
public:

	//! constructor
	COrthoCameraRH(ISceneNode* parent, irr::scene::ISceneManager* mgr, irr::s32 id, 
...
public:
	...
	void	SetBaseWidth(irr::f32 width);

	irr::f32	GetBaseWidth() const;
...
protected:
	...
	irr::f32 BaseWidth;	// Field of view, in radians. 
	irr::f32 AspectRatio;
