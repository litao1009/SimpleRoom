#ifndef CameraInterpolationAnimator_h__
#define CameraInterpolationAnimator_h__
...
class CameraInterpolationAnimator : public irr::scene::ISceneNodeAnimatorFinishing
{
public:
...
public:
	...
	//! constructor
	CameraInterpolationAnimator(irr::u32 startTime,
...
public:
	...
	const irr::core::matrix4&	GetCurProjMatrix() const { return CurProj; }
...
protected:
	...
	irr::core::matrix4	FromProj;
	irr::core::matrix4	ToProj;
	irr::core::matrix4	CurProj;
...
#endif // CameraInterpolationAnimator