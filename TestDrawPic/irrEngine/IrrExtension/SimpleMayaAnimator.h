#ifndef SimpleMayaAnimator_h__
#define SimpleMayaAnimator_h__
...
class CSimpleMayaAnimator : public irr::scene::ISceneNodeAnimatorCameraFPS
{
public:

	//! Constructor
	CSimpleMayaAnimator(irr::gui::ICursorControl* cursorControl,
		irr::f32 rotateSpeed = 100.0f, irr::f32 moveSpeed = 2.f);

	//! Destructor
	virtual ~CSimpleMayaAnimator();
