...
#define WM_USER_ROOMLAYOUT_DRAWWALL				DEFINE_USER_MESSAGE(EUT_ROOMLAYOUT_DRAWWALL)
#define WM_USER_ROOMLAYOUT_DRAWWALL_FINISH		DEFINE_USER_MESSAGE(EUT_ROOMLAYOUT_DRAWLINE_FINISH)
