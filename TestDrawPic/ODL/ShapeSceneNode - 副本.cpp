...
void ShapeSceneNode::UpdateTransformedShape()
{
	...
	TransformedBndBox_ = BaseBndBox_.Transformed(GetTransform());
	TransformedShape_ = BaseShape_.Moved(GetTransform());
	TransformedSelector_.LoadS1(TransformedShape_);
}
...
const TopoDS_Shape& ShapeSceneNode::GetTransformedShape()
{
	return TransformedShape_;
}

ShapeSceneNode::ShapeSelector& ShapeSceneNode::GetTransformedSelector()
{
	return TransformedSelector_;
}

const Bnd_Box& ShapeSceneNode::GetTransformedBndBox()
{
	return TransformedBndBox_;
}
