...
#ifndef __C_SCENE_NODE_ANIMATOR_CAMERA_FPSRH_H_INCLUDED__
#define __C_SCENE_NODE_ANIMATOR_CAMERA_FPSRH_H_INCLUDED__
...
namespace scene
{
	...
	class CSceneNodeAnimatorCameraFPSRH : public ISceneNodeAnimatorCameraFPS
	{
	public:

		//! Constructor
		CSceneNodeAnimatorCameraFPSRH(gui::ICursorControl* cursorControl,
		...
		//! Destructor
		virtual ~CSceneNodeAnimatorCameraFPSRH();
