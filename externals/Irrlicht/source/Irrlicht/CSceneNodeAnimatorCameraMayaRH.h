...
#ifndef __C_SCENE_NODE_ANIMATOR_CAMERA_MAYA_RH_H_INCLUDED__
#define __C_SCENE_NODE_ANIMATOR_CAMERA_MAYA_RH_H_INCLUDED__
...
namespace scene
{
	...
	*/
	class CSceneNodeAnimatorCameraMayaRH : public ISceneNodeAnimatorCameraMaya 
	{
	public:
		...
		//! Constructor
		CSceneNodeAnimatorCameraMayaRH(gui::ICursorControl* cursor, f32 rotateSpeed = -1500.f, 
			f32 zoomSpeed = 200.f, f32 translationSpeed = 1500.f, f32 distance=70.f);

		//! Destructor
		virtual ~CSceneNodeAnimatorCameraMayaRH();
