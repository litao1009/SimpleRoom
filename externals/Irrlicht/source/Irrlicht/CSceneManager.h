...
namespace scene
{
	...
	*/
	...
	public:
		...
		virtual ICameraSceneNode* addCameraSceneNodeRH(ISceneNode* parent = 0,
			const core::vector3df& position = core::vector3df(0,0,0),
			const core::vector3df& lookat = core::vector3df(0,0,100),
			s32 id=-1, bool makeActive=true);
		...
		virtual ICameraSceneNode* addCameraSceneNodeMayaRH(ISceneNode* parent=0,
			f32 rotateSpeed=-1500.f, f32 zoomSpeed=200.f,
			f32 translationSpeed=1500.f, s32 id=-1, f32 distance=70.f,
			bool makeActive=true);
		...
		virtual ICameraSceneNode* addCameraSceneNodeFPSRH(ISceneNode* parent = 0,
