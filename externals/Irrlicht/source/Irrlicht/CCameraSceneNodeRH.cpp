...
//! constructor
CCameraSceneNodeRH::CCameraSceneNodeRH(ISceneNode* parent, ISceneManager* mgr, s32 id,
...
{
	#ifdef _DEBUG
	setDebugName("CCameraSceneNodeRH");
	#endif
...
void CCameraSceneNodeRH::setInputReceiverEnabled(bool enabled)
{
...
bool CCameraSceneNodeRH::isInputReceiverEnabled() const
{
...
void CCameraSceneNodeRH::setProjectionMatrix(const core::matrix4& projection, bool isOrthogonal)
{
...
const core::matrix4& CCameraSceneNodeRH::getProjectionMatrix() const
{
...
const core::matrix4& CCameraSceneNodeRH::getViewMatrix() const
{
...
void CCameraSceneNodeRH::setViewMatrixAffector(const core::matrix4& affector)
{
	Affector = affector;
}
...
const core::matrix4& CCameraSceneNodeRH::getViewMatrixAffector() const
{
	return Affector;
}
...
bool CCameraSceneNodeRH::OnEvent(const SEvent& event)
{
...
void CCameraSceneNodeRH::setTarget(const core::vector3df& pos)
{
	Target = pos;
...
void CCameraSceneNodeRH::setRotation(const core::vector3df& rotation)
{
	if(TargetAndRotationAreBound)
...
const core::vector3df& CCameraSceneNodeRH::getTarget() const
{
	return Target;
}
...
void CCameraSceneNodeRH::setUpVector(const core::vector3df& pos)
{
	UpVector = pos;
}
...
const core::vector3df& CCameraSceneNodeRH::getUpVector() const
{
	return UpVector;
}


f32 CCameraSceneNodeRH::getNearValue() const
{
	return ZNear;
}


f32 CCameraSceneNodeRH::getFarValue() const
{
	return ZFar;
}


f32 CCameraSceneNodeRH::getAspectRatio() const
{
	return Aspect;
}


f32 CCameraSceneNodeRH::getFOV() const
{
	return Fovy;
}


void CCameraSceneNodeRH::setNearValue(f32 f)
{
	ZNear = f;
	recalculateProjectionMatrix();
}
...
void CCameraSceneNodeRH::setFarValue(f32 f)
{
	ZFar = f;
	recalculateProjectionMatrix();
}
...
void CCameraSceneNodeRH::setAspectRatio(f32 f)
{
	Aspect = f;
	recalculateProjectionMatrix();
}
...
void CCameraSceneNodeRH::setFOV(f32 f)
{
	Fovy = f;
	recalculateProjectionMatrix();
}
...
void CCameraSceneNodeRH::recalculateProjectionMatrix()
{
...
//! prerender
void CCameraSceneNodeRH::OnRegisterSceneNode()
{
...
//! render
void CCameraSceneNodeRH::render()
{
...
const core::aabbox3d<f32>& CCameraSceneNodeRH::getBoundingBox() const
{
...
const SViewFrustum* CCameraSceneNodeRH::getViewFrustum() const
{
	return &ViewArea;
}


void CCameraSceneNodeRH::recalculateViewArea()
{
...
void CCameraSceneNodeRH::serializeAttributes(io::IAttributes* out, io::SAttributeReadWriteOptions* options) const
{
...
void CCameraSceneNodeRH::deserializeAttributes(io::IAttributes* in, io::SAttributeReadWriteOptions* options)
{
...
void CCameraSceneNodeRH::bindTargetAndRotation(bool bound)
{
...
bool CCameraSceneNodeRH::getTargetAndRotationBinding(void) const
{
...
ISceneNode* CCameraSceneNodeRH::clone(ISceneNode* newParent, ISceneManager* newManager)
{
	...
	CCameraSceneNodeRH* nb = new CCameraSceneNodeRH(newParent,
