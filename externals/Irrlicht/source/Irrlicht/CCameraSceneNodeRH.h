...
#ifndef __C_CAMERA_SCENE_NODE_RH_H_INCLUDED__
#define __C_CAMERA_SCENE_NODE_RH_H_INCLUDED__
...
namespace scene
{
	...
	class CCameraSceneNodeRH : public ICameraSceneNode
	{
	public:

		//! constructor
		CCameraSceneNodeRH(ISceneNode* parent, ISceneManager* mgr, s32 id, 
